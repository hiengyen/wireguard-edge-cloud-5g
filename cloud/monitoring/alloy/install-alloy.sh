#!/bin/bash
# ==============================================================
# Install Grafana Alloy on the cloud node and forward journald logs
# to the local Loki endpoint.
# ==============================================================
...
ALLOY_LOKI_URL="${ALLOY_LOKI_URL:-http://${MONITORING_BIND_ADDRESS}:${LOKI_PORT}/loki/api/v1/push}"
